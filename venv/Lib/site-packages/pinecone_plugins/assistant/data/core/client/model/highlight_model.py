...
class HighlightModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, content, *args, **kwargs):  # noqa: E501
        """HighlightModel - a model defined in OpenAPI

        Args:
            type (str): The type of the highlight. Currently it is always text.
            content (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, content, *args, **kwargs):  # noqa: E501
        """HighlightModel - a model defined in OpenAPI
